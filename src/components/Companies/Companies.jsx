        ...
        <div className='companies'>
            <div className='section-title'>
                <div className='container'>
                    <div className="header scrollAnimation">
            ...
            <div className="container mt-2">
                <div className="row gapp">
                    <div className="col-lg-7 order-sm-last order-lg-first" data-aos="fade-down-right" data-aos-duration="1000">
                    ...
                    <div className="col-lg-5 order-sm-first order-lg-last mb-4" data-aos="flip-left" data-aos-duration="1000">
